 ...
 */
passport.use(new LocalStrategy(config.passport.local, (email, password, done) => {
 ...
 * Sign in with GitHub.
 */
passport.use(new GitHubStrategy(config.passport.github, (req, accessToken, refreshToken, profile, done) => {
  if (req.user) {
 ...
 */
passport.use(new TwitterStrategy(config.passport.twitter, (req, accessToken, tokenSecret, profile, done) => {
  if (req.user) {
 ...
 * Sign in with Google.
 */
const googleStrategyConfig = new GoogleStrategy(config.passport.google, (req, accessToken, refreshToken, params, profile, done) => {
  if (req.user) {
 ...
 */
passport.use(new LinkedInStrategy(config.passport.linkedIn, (req, accessToken, refreshToken, profile, done) => {
  if (req.user) {
