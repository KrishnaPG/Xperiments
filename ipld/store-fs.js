...
class FsDatastore {
   ...
   */
	putRaw(key /* : Key */, val /* : Buffer */, callback /* : Callback<void> */) /* : void */ {
		...
		console.log(`[fs putRaw ${(new Date()).toLocaleString()}]: `, parts.file, key.toString());
   ...
   */
	put(key /* : Key */, val /* : Buffer */, callback /* : Callback<void> */) /* : void */ {
		const parts = this._encode(key)
		console.log(`[fs put ${(new Date()).toLocaleString()}]: `, parts.file, key.toString());
		waterfall([
			(cb) => mkdirp(parts.dir, { fs: fs }, cb),
   ...
   */
	getRaw(key /* : Key */, callback /* : Callback<Buffer> */) /* : void */ {
		const parts = this._encode(key)
		console.log(`[fs getRaw ${(new Date()).toLocaleString()}]: `, parts.file, key.toString());
		let file = parts.file
   ...
   */
	get(key /* : Key */, callback /* : Callback<Buffer> */) /* : void */ {
		const parts = this._encode(key)
		console.log(`[fs get ${(new Date()).toLocaleString()}]: `, parts.file, key.toString());
   ...
   */
	has(key /* : Key */, callback /* : Callback<bool> */) /* : void */ {
		const parts = this._encode(key)
		console.log(`[fs has ${(new Date()).toLocaleString()}]: `, parts.file, key.toString());
